...
define('G5_MYSQL_USER', 'greengnu');
define('G5_MYSQL_PASSWORD', '12345');
define('G5_MYSQL_DB', 'greengnu');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '2c228bf9d8d0d0d703300a53f7082c8b'); // 토큰 암호화에 사용할 키
